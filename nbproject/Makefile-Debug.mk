...
${OBJECTDIR}/src/atom_base.o: src/atom_base.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atom_base.o src/atom_base.cpp

${OBJECTDIR}/src/atom_factory.o: src/atom_factory.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atom_factory.o src/atom_factory.cpp

${OBJECTDIR}/src/atom_list.o: src/atom_list.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atom_list.o src/atom_list.cpp

${OBJECTDIR}/src/atom_mdat.o: src/atom_mdat.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atom_mdat.o src/atom_mdat.cpp
